...
function Champions() {
  return (
    <div className=' box-border  font-sans bg-white dark:bg-gray-900 dark:text-white mt-10 mx-5 rounded pt-5 pl-4 pb-4 lg:w-[70%] lg:ml-16  pr-5 drop-shadow-2xl'>
      <div className='lg:hidden mb-5'>
        <ul className=' uppercase text-base font-semibold'>
          ...
          <li className='hover:text-red-600 pt-3'>
            <Link to='/EuropaLeague'>Europa League</Link>
          </li>
        </ul>
      </div>
      ...
      >
        <iframe
          ...
          src='https://www.scoreaxis.com/widget/standings-widget/2?&amp;links=0&amp;font=0&amp;textColor=%23000000&amp;inst=ac4e2'
          style={{
            width: '100%',
            border: 'none',
        ...
        <script>
          ...
          {window.addEventListener(
            'message',
            (event) => {
              if (event.data.appHeight && 'ac4e2' === event.data.inst) {
                let container = document.querySelector(
                  '#scoreaxis-widget-ac4e2 iframe'
                );
                container &&
