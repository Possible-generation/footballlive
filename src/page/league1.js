...
function league1() {
  return (
    <div className=' box-border  font-sans bg-white dark:bg-gray-900 dark:text-white mt-10 mx-5 rounded pt-5 pl-4 pb-4 lg:w-[70%] lg:ml-16  pr-5'>
      ...
      <div className='font-bold text-2xl  lg:text-4xl pb-5'>Ligue 1</div>
      <hr />
      <br></br>
      <div
        id='scoreaxis-widget-50dea'
        style={{
          borderWidth: '1px',
      ...
      >
        <iframe
          title='Ligue 1'
          id='Iframe'
          src='https://www.scoreaxis.com/widget/standings-widget/301?links=0&amptextColor=%23000000&amp;inst=50dea'
          style={{
            width: '100%',
            border: 'none',
        ...
        <script>
          ...
          {window.addEventListener(
            'message',
            (event) => {
              if (event.data.appHeight && '50dea' === event.data.inst) {
                let container = document.querySelector(
                  '#scoreaxis-widget-50dea iframe'
                );
                container &&
