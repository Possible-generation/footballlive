...
function Bundesliga() {
  return (
    <div className=' box-border  font-sans bg-white mt-10dark:bg-gray-900 dark:text-white  mx-5 rounded pt-5 pl-4 pb-4 lg:w-[70%] lg:ml-16  pr-5 '>
      ...
      <div className='font-bold text-2xl  lg:text-4xl pb-5'>Bundesliga</div>
      <hr />
      <br></br>
      <div
        id='scoreaxis-widget-6dd26'
        style={{
          borderWidth: '1px',
      ...
      >
        <iframe
          title='Bundesliga'
          id='Iframe'
          src='https://www.scoreaxis.com/widget/standings-widget/82?links=0&amp;font=0&amp;textColor=%23000000&amp;inst=6dd26'
          style={{
            width: '100%',
            border: 'none',
        ...
        <script>
          ...
          {window.addEventListener(
            'message',
            (event) => {
              if (event.data.appHeight && '6dd26' === event.data.inst) {
                let container = document.querySelector(
                  '#scoreaxis-widget-6dd26 iframe'
                );
                container &&
